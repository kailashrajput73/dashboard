...
function base64ToBytes(value: string) { const binary = typeof atob === "function" ? atob(value) : globalThis.Buffer ? globalThis.Buffer.from(value, "base64").toString("binary") : ""; return Uint8Array.from(binary, (character) => character.charCodeAt(0)); }
